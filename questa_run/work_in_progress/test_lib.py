...
def parser():
    ...
    parser.add_argument('-n','--name',help="Module Name",required=False,default=None)
    parser.add_argument('-dm','--default_module',help='Check Built-In Modules',action='store_true',required=False,default=None)
...
if __name__ == "__main__":
    ...
    if not arg.name == None:
        check_python_installation(arg.name)
